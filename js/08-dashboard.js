  ...
  el.innerHTML = books.map(name => {
    ...
    return `<div class="dbook-card">
      ...
      <div class="dbook-actions">
        ...
        <select class="dbook-status-sel" onchange="changeBookStatus('${name.replace(/'/g,"\\'")}',this.value)">
        ...
        <select class="dbook-cat-sel" onchange="changeBookCategory('${name.replace(/'/g,"\\'")}',this.value)">
